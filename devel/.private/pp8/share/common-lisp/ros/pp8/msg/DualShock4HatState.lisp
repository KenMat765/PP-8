...
(cl:defmethod cl:initialize-instance :after ((m <DualShock4HatState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DualShock4HatState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pp8-msg:<DualShock4HatState> is deprecated: use pp8-msg:DualShock4HatState instead.")))

(cl:ensure-generic-function 'hat_x-val :lambda-list '(m))
(cl:defmethod hat_x-val ((m <DualShock4HatState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8-msg:hat_x-val is deprecated.  Use pp8-msg:hat_x instead.")
  (hat_x m))

(cl:ensure-generic-function 'hat_y-val :lambda-list '(m))
(cl:defmethod hat_y-val ((m <DualShock4HatState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8-msg:hat_y-val is deprecated.  Use pp8-msg:hat_y instead.")
  (hat_y m))
