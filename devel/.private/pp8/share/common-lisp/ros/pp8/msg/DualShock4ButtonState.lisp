...
(cl:defmethod cl:initialize-instance :after ((m <DualShock4ButtonState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DualShock4ButtonState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pp8-msg:<DualShock4ButtonState> is deprecated: use pp8-msg:DualShock4ButtonState instead.")))

(cl:ensure-generic-function 'square-val :lambda-list '(m))
(cl:defmethod square-val ((m <DualShock4ButtonState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8-msg:square-val is deprecated.  Use pp8-msg:square instead.")
  (square m))

(cl:ensure-generic-function 'cross-val :lambda-list '(m))
(cl:defmethod cross-val ((m <DualShock4ButtonState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8-msg:cross-val is deprecated.  Use pp8-msg:cross instead.")
  (cross m))

(cl:ensure-generic-function 'circle-val :lambda-list '(m))
(cl:defmethod circle-val ((m <DualShock4ButtonState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8-msg:circle-val is deprecated.  Use pp8-msg:circle instead.")
  (circle m))

(cl:ensure-generic-function 'triangle-val :lambda-list '(m))
(cl:defmethod triangle-val ((m <DualShock4ButtonState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8-msg:triangle-val is deprecated.  Use pp8-msg:triangle instead.")
  (triangle m))

(cl:ensure-generic-function 'L1-val :lambda-list '(m))
(cl:defmethod L1-val ((m <DualShock4ButtonState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8-msg:L1-val is deprecated.  Use pp8-msg:L1 instead.")
  (L1 m))

(cl:ensure-generic-function 'L2-val :lambda-list '(m))
(cl:defmethod L2-val ((m <DualShock4ButtonState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8-msg:L2-val is deprecated.  Use pp8-msg:L2 instead.")
  (L2 m))

(cl:ensure-generic-function 'R1-val :lambda-list '(m))
(cl:defmethod R1-val ((m <DualShock4ButtonState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8-msg:R1-val is deprecated.  Use pp8-msg:R1 instead.")
  (R1 m))

(cl:ensure-generic-function 'R2-val :lambda-list '(m))
(cl:defmethod R2-val ((m <DualShock4ButtonState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8-msg:R2-val is deprecated.  Use pp8-msg:R2 instead.")
  (R2 m))

(cl:ensure-generic-function 'option-val :lambda-list '(m))
(cl:defmethod option-val ((m <DualShock4ButtonState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8-msg:option-val is deprecated.  Use pp8-msg:option instead.")
  (option m))
