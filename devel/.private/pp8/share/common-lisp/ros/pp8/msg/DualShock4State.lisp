...
(cl:defclass <DualShock4State> (roslisp-msg-protocol:ros-message)
  ((btn_state
    :reader btn_state
    :initarg :btn_state
    :type pp8-msg:DualShock4ButtonState
    :initform (cl:make-instance 'pp8-msg:DualShock4ButtonState))
   (hat_state
    :reader hat_state
    :initarg :hat_state
    :type pp8-msg:DualShock4HatState
    :initform (cl:make-instance 'pp8-msg:DualShock4HatState))
   (joy_state
    :reader joy_state
    :initarg :joy_state
    :type pp8-msg:DualShock4JoyStickState
    :initform (cl:make-instance 'pp8-msg:DualShock4JoyStickState)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DualShock4State>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DualShock4State)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pp8-msg:<DualShock4State> is deprecated: use pp8-msg:DualShock4State instead.")))

(cl:ensure-generic-function 'btn_state-val :lambda-list '(m))
(cl:defmethod btn_state-val ((m <DualShock4State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8-msg:btn_state-val is deprecated.  Use pp8-msg:btn_state instead.")
  (btn_state m))

(cl:ensure-generic-function 'hat_state-val :lambda-list '(m))
(cl:defmethod hat_state-val ((m <DualShock4State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8-msg:hat_state-val is deprecated.  Use pp8-msg:hat_state instead.")
  (hat_state m))

(cl:ensure-generic-function 'joy_state-val :lambda-list '(m))
(cl:defmethod joy_state-val ((m <DualShock4State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8-msg:joy_state-val is deprecated.  Use pp8-msg:joy_state instead.")
  (joy_state m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DualShock4State>)))
  ...
  (cl:format cl:nil "#DualShock4 State message~%DualShock4ButtonState btn_state~%DualShock4HatState hat_state~%DualShock4JoyStickState joy_state~%~%================================================================================~%MSG: pp8/DualShock4ButtonState~%# DualShock4 Button State message~%std_msgs/Bool square~%std_msgs/Bool cross~%std_msgs/Bool circle~%std_msgs/Bool triangle~%std_msgs/Bool L1~%std_msgs/Bool L2~%std_msgs/Bool R1~%std_msgs/Bool R2~%std_msgs/Bool option~%~%~%================================================================================~%MSG: std_msgs/Bool~%bool data~%================================================================================~%MSG: pp8/DualShock4HatState~%#DualShock4 Hat State message~%int8 hat_x~%int8 hat_y~%~%================================================================================~%MSG: pp8/DualShock4JoyStickState~%#DualShock4 JoyStick State message~%float64 l_x~%float64 l_y~%float64 r_x~%float64 r_y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DualShock4State)))
  "Returns full string definition for message of type 'DualShock4State"
  (cl:format cl:nil "#DualShock4 State message~%DualShock4ButtonState btn_state~%DualShock4HatState hat_state~%DualShock4JoyStickState joy_state~%~%================================================================================~%MSG: pp8/DualShock4ButtonState~%# DualShock4 Button State message~%std_msgs/Bool square~%std_msgs/Bool cross~%std_msgs/Bool circle~%std_msgs/Bool triangle~%std_msgs/Bool L1~%std_msgs/Bool L2~%std_msgs/Bool R1~%std_msgs/Bool R2~%std_msgs/Bool option~%~%~%================================================================================~%MSG: std_msgs/Bool~%bool data~%================================================================================~%MSG: pp8/DualShock4HatState~%#DualShock4 Hat State message~%int8 hat_x~%int8 hat_y~%~%================================================================================~%MSG: pp8/DualShock4JoyStickState~%#DualShock4 JoyStick State message~%float64 l_x~%float64 l_y~%float64 r_x~%float64 r_y~%~%~%"))
