...
(cl:defmethod cl:initialize-instance :after ((m <DualShock4JoyStickState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DualShock4JoyStickState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pp8_msgs-msg:<DualShock4JoyStickState> is deprecated: use pp8_msgs-msg:DualShock4JoyStickState instead.")))

(cl:ensure-generic-function 'l_x-val :lambda-list '(m))
(cl:defmethod l_x-val ((m <DualShock4JoyStickState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8_msgs-msg:l_x-val is deprecated.  Use pp8_msgs-msg:l_x instead.")
  (l_x m))

(cl:ensure-generic-function 'l_y-val :lambda-list '(m))
(cl:defmethod l_y-val ((m <DualShock4JoyStickState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8_msgs-msg:l_y-val is deprecated.  Use pp8_msgs-msg:l_y instead.")
  (l_y m))

(cl:ensure-generic-function 'r_x-val :lambda-list '(m))
(cl:defmethod r_x-val ((m <DualShock4JoyStickState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8_msgs-msg:r_x-val is deprecated.  Use pp8_msgs-msg:r_x instead.")
  (r_x m))

(cl:ensure-generic-function 'r_y-val :lambda-list '(m))
(cl:defmethod r_y-val ((m <DualShock4JoyStickState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pp8_msgs-msg:r_y-val is deprecated.  Use pp8_msgs-msg:r_y instead.")
  (r_y m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DualShock4JoyStickState>)))
  ...
  "pp8_msgs/DualShock4JoyStickState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DualShock4JoyStickState)))
  "Returns string type for a message object of type 'DualShock4JoyStickState"
  "pp8_msgs/DualShock4JoyStickState")
